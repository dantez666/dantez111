...
![Кабель UTP Cat.5 и разъем RJ-45](img/img1.jpg)  
...
![Топология звезда и прямое соединение ПК](img/img2.jpg)  
...
| *Рис. 3а – Прямой кабель* | *Рис. 3б – Перекрестный кабель* |

### 2.4. Гальваническая развязка

  
![Гальваническая развязка](img/img4.jpg)  
...
![Обжимной инструмент](img/img5.jpg)  
...
| *Рис. 6а – Стандарт T568A* | *Рис. 6б – Стандарт T568B* |

### 2.7. Порядок обжима вилки


  
![Порядок обжима вилки](img/img7.jpg)  
*Рис. 7 – Порядок обжима вилки RJ-45*


### 2.8. Монтаж 4-жильного кабеля

![4-жильный кабель](img/img8.jpg)  
...
![Сетевая карта PCI](img/img9.jpg)  
...
1. **Какие сетевые кабели использует технология Ethernet? Что такое кабель UTP? В чем его достоинства и недостатки?**
   ...
   > Кабели Ethernet: витая пара (UTP/FTP), оптоволокно, ранее — коаксиал.
UTP: неэкранированная витая пара.
Достоинства: дешевый, гибкий, простой в монтаже.
Недостатки: чувствителен к помехам, максимальная длина 100 м.

2. **Что такое сетевые устройства MDI и MDIX? Для соединения каких устройств необходим "перекрестный" (кроссированный) кабель?**

   > Кросс-кабель нужен для соединения однотипных устройств (комп → комп, свитч → свитч), если нет автоопределения (Auto-MDIX).

3. **Почему при монтаже вилки RJ-45 на кабель нет необходимости снимать изоляцию с отдельных жил кабеля?**

   > Контакты вилки имеют ножи (IDC), которые прорезают изоляцию и врезаются в медь при обжиме. Зачистка ослабляет контакт и может повредить жилу.

4. **Что такое "нуль-модемный" кабель и для каких целей он применяется?**

   > Перекрещенный последовательный кабель (RS-232) для прямого соединения двух устройств (например, ПК-ПК, ПК-консоль сетевого устройства).

5. **Каким образом однозначно идентифицируются сетевые адаптеры? С какой целью введена возможность изменения MAC-адреса?**

   > По уникальному MAC-адресу (48 бит, часть производителя + номер устройства).
Зачем менять: обход фильтрации, безопасность, тестирование, решение конфликтов.

6. **В чем заключается процесс конфигурирование сетевой платы? Какие параметры при этом настраиваются?**
   > Процесс: установка драйвера → настройка параметров в ОС.
Параметры: IP-адрес, маска, шлюз, DNS, скорость/дуплекс (редко), WoL, VLAN.
